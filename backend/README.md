...
- O usuário precisar confirma a nova senha para resetar a sua senha;
...
- Os agendamentos deve estar disponiveis entre 8h às 18h (Primeiro as 8h último as 17h);
- O usuário não pde agendar em um horário já ocupado;
